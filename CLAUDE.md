...
| 3. V0.1 七件事 polish | 🔨 进行中 | #1 端到端真跑 ✅（含一波大 polish + 提前做 Markdown / Message actions / 流式生成）；剩 Multi-session + Session 恢复 + Onboarding 真 validation + Settings path picker + tool_events 持久化 + macOS bundle |
